...
import 'package:newproject/app/modules/settings/controllers/terms_and_condition_view_controller.dart';
...
class TermsAndConditionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    TermsAndConditionViewController termsAndConditionViewController = Get.put(
      TermsAndConditionViewController(),
    );
    termsAndConditionViewController.fetchTerms();
            ...
            child: Obx(
              () => Column(
                ...
                children: [
                  ...
                  if (termsAndConditionViewController.isLoading.value)
                    Center(child: CircularProgressIndicator()),
                  SizedBox(
                    width: 360.w,
                    child: Text(
                      termsAndConditionViewController.privacyContent.value,
                      style: TextStyle(
